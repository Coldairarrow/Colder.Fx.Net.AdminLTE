# Colder快速开发框架文档(NET452+AdminLTE版)
...
使用技术栈：
后端：采用.NET平台，ASP.NET MVC，C#语言（使用反射等高级技术），Entity Framework（数据库ORM框架）。
...
默认生成后的文件是**隐藏**的，需要点击显示所有文件按钮，即可看到生成后的新文件
...
![](https://s2.ax1x.com/2019/06/22/Z9wRYV.png)
...
实际使用中个人推荐使用**雪花Id的mod分片规**，这也是为什么前面数据库设计规范中默认使用雪花Id作为数据库主键的原因（PS，之前版本使用GUID作为主键被各种嫌弃，这次看你们怎么说）![](https://timgsa.baidu.com/timg?image&quality=80&size=b9999_10000&sec=1561205621627&di=108f671b1c1b2d714c85f098c78e1bb4&imgtype=0&src=http%3A%2F%2Fimage.biaobaiju.com%2Fuploads%2F20181025%2F22%2F1540476004-sWcISuHJyM.jpg)
